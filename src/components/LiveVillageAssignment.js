...
function LiveVillageAssignment({assignment, performClick}) {
    return (
        <div className={"grid grid-cols-10 my-4 items-center bg-violet-400 m-4 rounded content-center cursor-grab"} key={assignment.player}>
            ...
            <div className={"p-2 rounded bg-green-300 w-3/4 my-4 mx-auto col-span-6"}>
...
export default LiveVillageAssignment;